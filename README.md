# Mise en oeuvre des architectures micro-services : Spring cloud Config, Consul Discovery, Consul Config, Vault
Projet visant à développer et interconnecter les microservices en utilisant la configuration Consul, une passerelle (Gateway), Feign Client, la configuration Vault, la sécurité Spring, ainsi qu'une interface utilisateur Frontend réalisée avec Angular.
